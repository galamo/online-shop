...
var addProductToCart_1 = require("./handlers/addProductToCart");
var cartsObjData = {};
// let cartArray = [{ cartId: 124, products: [] }]
cartRouter.post("/add-product", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, productPrice, quantity, productId, cartId, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log(req.body);
                    _a = req.body, productPrice = _a.productPrice, quantity = _a.quantity, productId = _a.productId, cartId = _a.cartId;
                    return [4 /*yield*/, (0, addProductToCart_1.addProductToCart)(productId, cartId, productPrice, quantity)
